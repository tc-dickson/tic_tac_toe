...
fn main() {
    let mut my_board = TicTacToeBoard::from_string(
        "X B B |
         O X B |
         X O O",
    );
    ...
    println!("check_status: {:?}", my_board.check_status());

    my_board.insert(&Point { x: 0, y: 1 }, SquareType::X);
    println!("Display version of my_board:\n\n{}\n", my_board);
    println!("blank_squares_set: {:?}", my_board.blank_squares_set);
    println!("check_status: {:?}", my_board.check_status());

    my_board.insert(&Point { x: 1, y: 2 }, SquareType::O);
    println!("Display version of my_board:\n\n{}\n", my_board);
    println!("blank_squares_set: {:?}", my_board.blank_squares_set);
    println!("check_status: {:?}", my_board.check_status());

    my_board.insert(&Point { x: 0, y: 2 }, SquareType::X);
    println!("Display version of my_board:\n\n{}\n", my_board);
    println!("blank_squares_set: {:?}", my_board.blank_squares_set);
    println!("check_status: {:?}", my_board.check_status());

    my_board.insert(&Point { x: 0, y: 2 }, SquareType::X);
    my_board.insert(&Point { x: 3, y: 3 }, SquareType::X);
